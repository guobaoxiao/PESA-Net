...
net_arg.add_argument(
    "--group", type=int, default=4, help=""
    "number of group in SAC Block. Default: 2")
net_arg.add_argument(
    "--split", type=int, default=1, help=""
    "number of split in SAC Block. Default: 2")
...
data_arg.add_argument(
    "--data_tr", type=str, default='/home/st003/ab/awin/OANet_bigdataset/yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default='/home/st003/ab/awin/OANet_bigdataset/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default='/home/st003/ab/awin/OANet_bigdataset/yfcc-sift-2000-test.hdf5', help=""
...
train_arg.add_argument(
    "--model", type=str, default='oan_splat_ZCB_SGall', help='model')
train_arg.add_argument(
...
# print('config:',config,'unparsed:',unparsed)
